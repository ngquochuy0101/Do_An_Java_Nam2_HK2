 ...
 * @author DELL
 */
public class CtphieunhapDTO_1 {
    String IdPhieunhap,IdCtphieunhhap,Tensp,Masp,link;
    int soluong;
    double dongia,thanhtien;

    public CtphieunhapDTO_1() {
    }

    public CtphieunhapDTO_1(String IdPhieunhap, String IdCtphieunhhap, String Tensp, String Masp, int soluong, double dongia, double thanhtien, String link) {
